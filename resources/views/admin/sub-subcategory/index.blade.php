...
@section('body')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Add Sub Subcategory Form</h4>
                    <p class ="text-center text-success">{{session('message')}}</p>
                    <form action="{{route('sub-subcategory.create')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-9">
                                ...
                                <div>
                                    <button type="submit" class="btn btn-primary w-md">Create New Sub Subcategory</button>
                                </div>
                            </div>
                        </div>
                    </form>
