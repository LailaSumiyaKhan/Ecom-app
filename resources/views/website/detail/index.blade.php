                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            ...
                            <div class="xzoom-thumbs">
                                ...
                                <a href="{{asset($otherImage->image)}}website/assets/images/gallery/original/02_o_car.jpg"><img class="xzoom-gallery" width="80" src="{{asset($otherImage->image)}}" title="The description goes here"></a>
                                @endforeach
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Product Category:<a href="javascript:void(0)">{{$product->subCategory->name}}</a></p>
                            <p class="category"><i class="lni lni-tag"></i> Product Category:<a href="javascript:void(0)">{{$product->brand->name}}</a></p>
