        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <strong>{{$tax}} TK</strong>
                </li>
                <li class="list-group-item d-flex justify-content-between">
                    <span>Shipping Cost</span>
                    @php($shipping = 500)
                    <strong>{{$shipping}} TK</strong>
                </li>
                @if(Session::get('cupon_amount'))
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Discount Amount</span>
                        @php($shipping = 500)
                        <strong>{{Session::get('cupon_amount')}} TK</strong>
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <strong>{{number_format($sum)}} TK </strong>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="address" name="address" placeholder="1234 Main St" required>{{$address}}</textarea>
                    <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="zip" value="1205" placeholder="" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
